...
sum(rate(istio_requests_total{
  destination_service="cart-canary.demo.svc.cluster.local",
...
# Canary request rate
sum(rate(istio_requests_total{
  destination_service="cart-stable.demo.svc.cluster.local",reporter="destination",
  response_code=~"2..",reporter="destination"
}[1m]))
...
sum(rate(istio_requests_total{
    ...
    destination_service_name="cart-canary",
    response_code="200"
}[1m]))
/
sum(rate(istio_requests_total{
